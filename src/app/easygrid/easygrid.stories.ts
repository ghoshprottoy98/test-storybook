...
export const Playground: Story = {
  args: {
      ...
      },
      {
        ...
        valueGetter: (params) => {
          if (params.data.scores) {
            return params.data.scores.reduce((acc: any, score: any) => acc + score, 0);
          }
          return 0;
        },
        lockPosition: false,
    ...
    dataSource: [
      { assessmentName: 'Math Test', assessmentType: 'Quiz', isActive: true, submissionDate: '01/01/2022', scores: [85, 90, 92] },
      { assessmentName: 'Science Project', assessmentType: 'Homework', isActive: false, submissionDate: '02/01/2022', scores: [78, 82] },
      { assessmentName: 'History Exam', assessmentType: 'Test', isActive: true, submissionDate: '03/01/2022', scores: [88] },
      { assessmentName: 'Geography Assignment', assessmentType: 'Homework', isActive: true, submissionDate: '04/01/2022', scores: [90, 85, 88] },
      { assessmentName: 'English Essay', assessmentType: 'Assignment', isActive: false, submissionDate: '05/01/2022', scores: [75] },
      { assessmentName: 'Physics Lab', assessmentType: 'Experiment', isActive: true, submissionDate: '06/01/2022', scores: [92, 94] },
      { assessmentName: 'Biology Quiz', assessmentType: 'Quiz', isActive: false, submissionDate: '07/01/2022', scores: [76] },
      { assessmentName: 'Chemistry Homework', assessmentType: 'Homework', isActive: true, submissionDate: '08/01/2022', scores: [82, 87] },
      { assessmentName: 'Computer Science Project', assessmentType: 'Project', isActive: false, submissionDate: '09/01/2022', scores: [88] },
      { assessmentName: 'Art Assignment', assessmentType: 'Assignment', isActive: true, submissionDate: '10/01/2022', scores: [90, 92] },
      { assessmentName: 'Music Test', assessmentType: 'Test', isActive: false, submissionDate: '11/01/2022', scores: [70] },
      { assessmentName: 'Drama Rehearsal', assessmentType: 'Performance', isActive: true, submissionDate: '12/01/2022', scores: [95] },
      { assessmentName: 'Economics Project', assessmentType: 'Project', isActive: false, submissionDate: '01/15/2022', scores: [80, 85] },
      { assessmentName: 'Philosophy Essay', assessmentType: 'Essay', isActive: true, submissionDate: '02/15/2022', scores: [90] },
      { assessmentName: 'Sociology Quiz', assessmentType: 'Quiz', isActive: false, submissionDate: '03/15/2022', scores: [74] },
      { assessmentName: 'Geography Test', assessmentType: 'Test', isActive: true, submissionDate: '04/15/2022', scores: [89] },
      { assessmentName: 'Psychology Assignment', assessmentType: 'Assignment', isActive: false, submissionDate: '05/15/2022', scores: [80] },
      { assessmentName: 'Statistics Homework', assessmentType: 'Homework', isActive: true, submissionDate: '06/15/2022', scores: [90, 95] },
      { assessmentName: 'Engineering Lab', assessmentType: 'Experiment', isActive: true, submissionDate: '07/15/2022', scores: [88] },
      { assessmentName: 'Astronomy Project', assessmentType: 'Project', isActive: false, submissionDate: '08/15/2022', scores: [82] },
      { assessmentName: 'Environmental Science Test', assessmentType: 'Test', isActive: true, submissionDate: '09/15/2022', scores: [85, 88] },
    ],
